...
public class UserApiController {
	...
	public ResponseDto<Integer> save(@RequestBody User user) { //username, password, email
		...
		//return new ResponseDto<Integer>(HttpStatus.OK.value(),result);  //OK가 enum타입이네 //DB에 인서트 하고나서 리턴된 결과값이 두번째 파라미터자리
	 ...
	 * login(@RequestBody User user){ //(@RequestBody User user, HttpSession
	 * session) 위애 DI로 안하면 이렇게도 가능
